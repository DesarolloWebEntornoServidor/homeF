...
namespace homeFinanceMVC.Controllers
{
    public class EventoController : Controller
    {
        ...
        public ActionResult ImprimirEventos(int? page)
        {

            int pageSize = 50000;
            int pageNumber = (page ?? 1);

            return View(evDAO.ListarTodosEventos().ToPagedList(pageNumber, pageSize));
        }
        ...
        private RelatorioDuplicata getRelatorio()
        {
            ...
            rpt.PageTitle = "Lista de Eventos";
            rpt.PageTitle = "Lista de Eventos";
        ...
        public ActionResult Preview()
        {
            ...
            return File(rpt.GetOutputE().GetBuffer(), "application/pdf");
        }
    }
}