...
namespace homeFinanceMVC.Models
{
    public abstract class TNEReport
    {
        ...
        public MemoryStream GetOutput()
        {
            ...
            {
                throw new Exception("Nada Para Mostrar");
            }
            ...
            try
            {
                ...
                if (writer.PageEmpty)
                {
                    doc.Add(new Paragraph("Nada para LIstar."));
                }
        ...
        public MemoryStream GetOutputU()
        {
            MontaCorpoDadosUsuario();
        ...
        public MemoryStream GetOutputE()
        {
            MontaCorpoDadosEvento();
        ...
        public virtual void MontaCorpoDadosUsuario()
        {
            if (!Paisagem)
            {
                doc = new Document(PageSize.A4, 20, 10, 80, 40);
        ...
        public virtual void MontaCorpoDadosEvento()
        {
            if (!Paisagem)
            {
                doc = new Document(PageSize.A4, 20, 10, 80, 40);
    ...
    public class MSPDFFooter : PdfPageEventHelper
    {
        ...
        private void ImprimeRodape(PdfWriter writer, Document doc)
        {
            ...
            if (ImprimirRodapePadrao)
            {
                ...
                #region Coluna TNE
                Image foot = Image.GetInstance(BasePath + @"\imagenes\homefinance50px.png");
                ...
                cell = new PdfPCell(new Phrase("Home Finance", negrito));
                cell.Border = 0;
                micros.AddCell(cell);
                cell = new PdfPCell(new Phrase("Control de Gastos", font));
                cell.Border = 0;
                micros.AddCell(cell);
                cell = new PdfPCell(new Phrase("https://homefinanceweb.es", font));
                cell.Border = 0;
                micros.AddCell(cell);
        ...
        private void ImprimeCabecalho(PdfWriter writer, Document doc)
        {
            ...
            if (ImprimirCabecalhoPadrao)
            {
                ...
                {
                    foot = Image.GetInstance(BasePath + @"\imagenes\homefinance80px.png");
                }
                foot.ScalePercent(60);
